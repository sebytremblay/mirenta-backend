...
echo -e "${GREEN}Database host:   ${YELLOW}${SUPABASE_DB_HOST:-${DB_HOST:-Not set}}${NC}"
echo -e "${GREEN}Database port:   ${YELLOW}${SUPABASE_DB_PORT:-${DB_PORT:-Not set}}${NC}"
echo -e "${GREEN}Database name:   ${YELLOW}${SUPABASE_DB_NAME:-${DB_NAME:-Not set}}${NC}"
echo -e "${GREEN}Database user:   ${YELLOW}${SUPABASE_DB_USER:-${DB_USER:-Not set}}${NC}"
