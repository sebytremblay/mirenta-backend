...
| Knowledge base                             | `supabase/migrations/0008_knowledge.sql`, `app/services/knowledge.py`, `app/api/routers/knowledge.py` | Implemented — CRUD + SMS prompt injection; voice not grounded yet |
